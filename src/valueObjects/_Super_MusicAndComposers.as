 ...
 * of this value object you may modify the generated sub-class of this class - MusicAndComposers.as.
 */
...
[ExcludeClass]
public class _Super_MusicAndComposers extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _MusicAndComposersEntityMetadata;
    ...
    private var _internal_musicID : int;
    ...
    public function _Super_MusicAndComposers()
    {
        _model = new _MusicAndComposersEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get musicID() : int
    {
    ...
    public function set musicID(value:int) : void
    {
        var oldValue:int = _internal_musicID;
        if (oldValue !== value)
        {
            _internal_musicID = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "musicID", oldValue, _internal_musicID));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _MusicAndComposersEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _MusicAndComposersEntityMetadata) : void
    {
        var oldValue : _MusicAndComposersEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
