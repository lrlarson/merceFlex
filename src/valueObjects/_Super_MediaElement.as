 ...
 * of this value object you may modify the generated sub-class of this class - MediaElement.as.
 */
...
[ExcludeClass]
public class _Super_MediaElement extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _MediaElementEntityMetadata;
    ...
    private var _internal_videoLink : String;
    ...
    private var _internal_publish : Object;
    ...
    public function _Super_MediaElement()
    {
        _model = new _MediaElementEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "videoLink", model_internal::setterListenerVideoLink));
    ...
    [Bindable(event="propertyChange")]
    public function get publish() : Object
    {
    ...
    public function set videoLink(value:String) : void
    {
        var oldValue:String = _internal_videoLink;
        if (oldValue !== value)
        {
            _internal_videoLink = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "videoLink", oldValue, _internal_videoLink));
        }
    }
    ...
    public function set publish(value:Object) : void
    {
        var oldValue:Object = _internal_publish;
        if (oldValue !== value)
        {
    ...
    model_internal function setterListenerVideoLink(value:flash.events.Event):void
    {
        _model.invalidateDependentOnVideoLink();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.videoLinkIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_videoLinkValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _MediaElementEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _MediaElementEntityMetadata) : void
    {
        var oldValue : _MediaElementEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfVideoLink : Array = null;
    model_internal var _doValidationLastValOfVideoLink : String;

    model_internal function _doValidationForVideoLink(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfVideoLink != null && model_internal::_doValidationLastValOfVideoLink == value)
           return model_internal::_doValidationCacheOfVideoLink ;

        _model.model_internal::_videoLinkIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isVideoLinkAvailable && _internal_videoLink == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "videoLink is required"));
        }

        model_internal::_doValidationCacheOfVideoLink = validationFailures;
        model_internal::_doValidationLastValOfVideoLink = value;
    ...
    model_internal var _doValidationLastValOfPublish : Object;
