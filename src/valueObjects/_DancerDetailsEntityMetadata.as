...
[ExcludeClass]
internal class _DancerDetailsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("dancer_LN", "dancer_FN", "workTitle", "revivalYear", "premiereCity", "premiereCountry", "id", "workLengthString", "workImageNotes", "revivalNotes", "length", "premiereString", "premiereVenue", "revivalLocation", "workImage", "premiereDate");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("dancer_LN", "dancer_FN", "workTitle", "revivalYear", "premiereCity", "premiereCountry", "id", "workLengthString", "workImageNotes", "revivalNotes", "length", "premiereString", "premiereVenue", "revivalLocation", "workImage", "premiereDate");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("dancer_LN", "dancer_FN", "workTitle", "revivalYear", "premiereCity", "premiereCountry", "id", "workLengthString", "workImageNotes", "revivalNotes", "length", "premiereString", "premiereVenue", "revivalLocation", "workImage", "premiereDate");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("dancer_LN", "dancer_FN", "workTitle", "revivalYear", "premiereCity", "premiereCountry", "id", "workLengthString", "workImageNotes", "revivalNotes", "length", "premiereString", "premiereVenue", "revivalLocation", "workImage", "premiereDate");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("dancer_LN", "dancer_FN", "workTitle", "revivalYear", "premiereCity", "premiereCountry", "id", "workLengthString", "workImageNotes", "revivalNotes", "length", "premiereString", "premiereVenue", "revivalLocation", "workImage", "premiereDate");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "DancerDetails";
    ...
    model_internal var _instance:_Super_DancerDetails;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _DancerDetailsEntityMetadata(value : _Super_DancerDetails)
    {
        ...
        model_internal::propertyTypeMap["workImage"] = "Object";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity DancerDetails");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity DancerDetails");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of DancerDetails");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity DancerDetails");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity DancerDetails");
        }
