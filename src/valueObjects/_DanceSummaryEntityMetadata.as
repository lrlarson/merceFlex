...
[ExcludeClass]
internal class _DanceSummaryEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "workTitle", "workLengthString", "revivalYear", "revivalNotes", "premiereCity", "length", "premiereCountry", "premiereString", "premiereVenue", "revivalLocation", "premiereDate", "data", "label");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "workTitle", "workLengthString", "revivalYear", "revivalNotes", "premiereCity", "length", "premiereCountry", "premiereString", "premiereVenue", "revivalLocation", "premiereDate", "data", "label");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "workTitle", "workLengthString", "revivalYear", "revivalNotes", "premiereCity", "length", "premiereCountry", "premiereString", "premiereVenue", "revivalLocation", "premiereDate", "data", "label");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "workTitle", "workLengthString", "revivalYear", "revivalNotes", "premiereCity", "length", "premiereCountry", "premiereString", "premiereVenue", "revivalLocation", "premiereDate", "data", "label");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "workTitle", "workLengthString", "revivalYear", "revivalNotes", "premiereCity", "length", "premiereCountry", "premiereString", "premiereVenue", "revivalLocation", "premiereDate", "data", "label");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "DanceSummary";
    ...
    model_internal var _instance:_Super_DanceSummary;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _DanceSummaryEntityMetadata(value : _Super_DanceSummary)
    {
        ...
        model_internal::propertyTypeMap["revivalYear"] = "String";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity DanceSummary");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity DanceSummary");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of DanceSummary");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity DanceSummary");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity DanceSummary");
        }
