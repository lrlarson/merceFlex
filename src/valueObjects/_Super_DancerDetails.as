 ...
 * of this value object you may modify the generated sub-class of this class - DancerDetails.as.
 */
...
[ExcludeClass]
public class _Super_DancerDetails extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DancerDetailsEntityMetadata;
    ...
    private var _internal_workImage : Object;
    ...
    public function _Super_DancerDetails()
    {
        _model = new _DancerDetailsEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get workImage() : Object
    {
    ...
    public function set workImage(value:Object) : void
    {
        var oldValue:Object = _internal_workImage;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DancerDetailsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DancerDetailsEntityMetadata) : void
    {
        var oldValue : _DancerDetailsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfWorkImage : Object;
