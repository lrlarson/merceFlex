...
[ExcludeClass]
internal class _MediaElementEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("link", "lengthString", "videoLink", "director", "id", "colorBW", "musicians", "title", "description", "length", "producer", "year", "distributor", "publish");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("link", "lengthString", "videoLink", "director", "id", "colorBW", "musicians", "title", "description", "length", "producer", "year", "distributor", "publish");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("link", "lengthString", "videoLink", "director", "id", "colorBW", "musicians", "title", "description", "length", "producer", "year", "distributor", "publish");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("link", "lengthString", "videoLink", "director", "id", "colorBW", "musicians", "title", "description", "length", "producer", "year", "distributor", "publish");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("link", "lengthString", "videoLink", "director", "id", "colorBW", "musicians", "title", "description", "length", "producer", "year", "distributor", "publish");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "MediaElement";
    ...
    model_internal var _videoLinkIsValid:Boolean;
    model_internal var _videoLinkValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _videoLinkIsValidCacheInitialized:Boolean = false;
    model_internal var _videoLinkValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_MediaElement;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _MediaElementEntityMetadata(value : _Super_MediaElement)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["videoLink"] = new Array();
        ...
        model_internal::propertyTypeMap["videoLink"] = "String";
        ...
        model_internal::propertyTypeMap["publish"] = "Object";
        ...
        model_internal::_videoLinkValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForVideoLink);
        model_internal::_videoLinkValidator.required = true;
        model_internal::_videoLinkValidator.requiredFieldError = "videoLink is required";
        //model_internal::_videoLinkValidator.source = model_internal::_instance;
        //model_internal::_videoLinkValidator.property = "videoLink";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity MediaElement");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity MediaElement");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of MediaElement");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity MediaElement");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity MediaElement");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isVideoLinkAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnVideoLink():void
    {
        if (model_internal::_videoLinkIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfVideoLink = null;
            model_internal::calculateVideoLinkIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get videoLinkStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get videoLinkValidator() : StyleValidator
    {
        return model_internal::_videoLinkValidator;
    }

    model_internal function set _videoLinkIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_videoLinkIsValid;         
        if (oldValue !== value)
        {
            model_internal::_videoLinkIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "videoLinkIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get videoLinkIsValid():Boolean
    {
        if (!model_internal::_videoLinkIsValidCacheInitialized)
        {
            model_internal::calculateVideoLinkIsValid();
        ...
        return model_internal::_videoLinkIsValid;
    }

    model_internal function calculateVideoLinkIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_videoLinkValidator.validate(model_internal::_instance.videoLink)
        model_internal::_videoLinkIsValid_der = (valRes.results == null);
        model_internal::_videoLinkIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::videoLinkValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::videoLinkValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get videoLinkValidationFailureMessages():Array
    {
        if (model_internal::_videoLinkValidationFailureMessages == null)
            model_internal::calculateVideoLinkIsValid();

        return _videoLinkValidationFailureMessages;
    }

    model_internal function set videoLinkValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_videoLinkValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_videoLinkValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "videoLinkValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("videoLink"):
            {
                return videoLinkValidationFailureMessages;
            }
            case("director"):
            {
